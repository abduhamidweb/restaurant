...
class RestaurantController {
    ...
    async findOne(req, res) {
        try {
            const restaurant = await Restaurant.findById(req.params.id).populate('resource').populate("workers").populate("users").populate('foods').populate('zakaz').populate('contactUs').populate('hero');
            if (!restaurant) {
